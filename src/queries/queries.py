...
INSERT_SUBPACKAGE_MANAGEMENT = """
    INSERT INTO subpackage_management
        ...
        is_cancelled,cancellation_time,payment_withdrawal_status,surrenderer,return_time,abnormality_type,package_status,operation_time,sector,current_date_,extraction_hour)
    VALUES
