...
class SortingOut(WebDriverWorkflowInterface):
    def __init__(self):
    ...
    def navigate_to_wms(self):        
            sorting_url = 'https://wms-br.biz.sheinbackend.com/#/outbound-mgt/sowing-management/sowing-detail'
            self.browser.get(sorting_url)
            time.sleep(5)

            select_time = self.wait_for_element(By.XPATH, '//*[@id="app"]/section/section/main/div/div/div/div/div/div/form/div[8]/div/div[2]/div/label/div')
            select_time.click()
            time.sleep(1)

            click_calendar = self.wait_for_element(By.XPATH,'//*[@id="app"]/section/section/main/div/div/div/div/div/div/form/div[8]/div/div[2]/div/label/div/div[2]/div/div/div/div/div[3]/div[25]')
            click_calendar.click()
            actions = ActionChains(self.browser)
            actions.double_click(click_calendar).perform()


            first_time = self.wait_for_element(By.XPATH, '//*[@id="app"]/section/section/main/div/div/div/div/div/div/form/div[8]/div/div[2]/div/label/div/div/div/div[2]/span')
            second_time = self.wait_for_element(By.XPATH, '//*[@id="app"]/section/section/main/div/div/div/div/div/div/form/div[8]/div/div[2]/div/label/div/div/div/div[2]/span[3]')
            first_time.click()
            ...
            btn_search = self.wait_for_element(By.XPATH, '//*[@id="app"]/section/section/main/div/div/div/div/div/div/form/div[9]/div/button')
            btn_search.click()
            time.sleep(1)
    ...
    def web_drive_workflow(self) -> None:     
        ...
        wms_report_download = WmsReportDownload(self.wait, self.browser, self.options,'sorting_out_')
