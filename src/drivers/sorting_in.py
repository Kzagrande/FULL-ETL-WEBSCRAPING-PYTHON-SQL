...
class SortingIn(SortingInInterface):
    def __init__(self):
    ...
    def sorting_in_workflow(self) -> None:     
        ...
        return file_name
        # wms_report_upload = WmsReportUpload(report_download['file_name'])
        # wms_report_upload.uplaod_sheet()

# if __name__ ==  "__main__":
#     sorting_in = SortingIn()
#     sorting_in.sorting_in_workflow()
