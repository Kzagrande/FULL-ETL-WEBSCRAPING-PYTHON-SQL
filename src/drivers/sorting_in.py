    ...
    def navigate_to_wms(self):
        try:
            ...
            select_time = self.wait_for_element(
                By.XPATH,
                '/html/body/div[2]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[7]/div/div[2]/div/label/div',
            )
            select_time.click()
            time.sleep(1)
            ...
            click_calendar = self.wait_for_element(
                By.XPATH,
                '/html/body/div[2]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[7]/div/div[2]/div/label/div/div[2]/div/div[1]/div[1]/div/div[3]/div[25]',
            )
            ...
            first_time = self.wait_for_element(
                By.XPATH,
                '/html/body/div[2]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[7]/div/div[2]/div/label/div/div[1]/div/div[2]/span[1]',
            )
            second_time = self.wait_for_element(
                By.XPATH,
                '/html/body/div[2]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[7]/div/div[2]/div/label/div/div[1]/div/div[2]/span[3]',
            )
            first_time.click()
            ...
            btn_search = self.wait_for_element(
                By.XPATH,
                '/html/body/div[2]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[8]/div/button[1]',
            )
            btn_search.click()
            time.sleep(1)
            ...
            btn_extract = self.wait_for_element(
                By.XPATH,
                '//*[@id="app"]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/section[1]/button',
            )
            btn_extract.click()
            time.sleep(1)
