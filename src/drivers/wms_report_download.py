    ...
    def download_sheet(self) -> Dict:
        try:
            ...
            if self.nave == 'D':
                ...
                my_file = self.wait_for_element(
                By.XPATH,
                '/html/body/div[2]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/section/div/div[1]/div[2]/div[2]/div/table/tbody/tr[td[contains(text(),"SPglp027")]][1]/td[2]',
            )
                my_file.click()
