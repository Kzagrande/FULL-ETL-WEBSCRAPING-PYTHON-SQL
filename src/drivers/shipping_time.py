...
class ShippingTime(WebDriverWorkflowInterface):
    ...
    def navigate_to_wms(self):
        try:
            ...
            shipping_time = self.wait_for_element(
                By.XPATH,
                '/html/body/div[2]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[10]/div/div[2]/div/div/div[1]/div[2]/div/div[2]/div/a[2]',
            )
            ...
            try:
                ...
                raise ErrorLog(
                    ...
                    func="Navigate_to_wms - Shipping_time",
                    error_code=1,
                )
            ...
            raise ErrorLog(
                message="Navigate_to_wms Shipping_time - ERROR",
