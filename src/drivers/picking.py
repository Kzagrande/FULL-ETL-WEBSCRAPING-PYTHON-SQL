    ...
    def navigate_to_wms(self):
        try:
            ...
            select_time = self.wait_for_element(
                By.XPATH,
                '//*[@id="app"]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[11]/div/div[2]/div/div[1]',
            )
            select_time.click()
            time.sleep(1)
            ...
            time_element = self.wait_for_element(
                By.XPATH,
                '//*[@id="app"]/div/div[1]/div/div/div[2]/section[3]/section/div[1]/div/div/div/div/div/form/div[11]/div/div[2]/div/div[2]/label/div',
            )
            time_element.click()
